...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.time_added'
        db.delete_column(u'articles_article', 'time_added')

        # Adding field 'Article.resolved_id'
        db.add_column(u'articles_article', 'resolved_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_index=True),
                      keep_default=False)

        # Adding field 'Article.time_updated'
        db.add_column(u'articles_article', 'time_updated',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Article.time_added'
        db.add_column(u'articles_article', 'time_added',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Article.resolved_id'
        db.delete_column(u'articles_article', 'resolved_id')

        # Deleting field 'Article.time_updated'
        db.delete_column(u'articles_article', 'time_updated')
    ...
    models = {
        ...
        u'articles.article': {
            ...
            'resolved_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'shared_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.UserAccount']"}),
            'time_updated': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'auth.group': {
