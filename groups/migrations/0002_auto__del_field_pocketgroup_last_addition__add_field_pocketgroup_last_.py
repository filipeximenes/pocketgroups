...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PocketGroup.last_addition'
        db.delete_column(u'groups_pocketgroup', 'last_addition')

        # Adding field 'PocketGroup.last_synced_article'
        db.add_column(u'groups_pocketgroup', 'last_synced_article',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.Article'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PocketGroup.last_addition'
        db.add_column(u'groups_pocketgroup', 'last_addition',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'PocketGroup.last_synced_article'
        db.delete_column(u'groups_pocketgroup', 'last_synced_article_id')
